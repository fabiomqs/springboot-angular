...
/**
 * REST controller for managing {@link com.github.fabiomqs.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
public class BlogResource {
    ...
    public ResponseEntity<Blog> partialUpdateBlog(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, blog.getId()));
    }
