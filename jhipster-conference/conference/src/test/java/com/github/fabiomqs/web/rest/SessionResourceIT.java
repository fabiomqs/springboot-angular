...
import static com.github.fabiomqs.web.rest.TestUtil.sameInstant;
...
class SessionResourceIT {
    ...
    void partialUpdateSessionWithPatch() throws Exception {
        ...
        partialUpdatedSession.description(UPDATED_DESCRIPTION).startDateTime(UPDATED_START_DATE_TIME).endDateTime(UPDATED_END_DATE_TIME);
